    ...
    <div className="grid grid-cols-9 gap-7">
      ...
      >
        <div className="contact-information">
          ...
          <p>Get in touch with me to know more about my skills and projects</p>
          ...
          <div className="contact-blocks mt-5 space-y-5">
            <div className="contact-block card flex p-4 md:p-5">
              ...
              <div className="content">
                ...
                <h5>
                  If you would like to connect, feel free
                  to send me a message. I will be happy to get back to you soon.
                </h5>
              </div>
            </div>
            <div className="contact-block card flex p-4 md:p-5">
